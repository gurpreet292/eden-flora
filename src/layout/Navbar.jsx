        ...
        <div className="flex items-center gap-3">
          ...
          {!user ? (
            ...
            <div className="relative hidden sm:block">
              <button onClick={() => setMenuOpen((current) => !current)} className="flex items-center gap-2 rounded-full border border-forest/15 bg-[#f5f2ea] px-3 py-2 text-[9px] font-bold uppercase tracking-[0.12em] text-forest/70 transition hover:border-gold">
              ...
              {menuOpen && (
                <div className="absolute right-0 mt-3 w-56 rounded-2xl border border-forest/10 bg-white p-3 shadow-[0_25px_60px_rgba(27,58,42,0.12)]">
